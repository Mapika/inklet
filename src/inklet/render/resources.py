...
def rendering_manifest(root):
    ...
    scenes, rasters, resources, paints, blends = [], [], {}, {}, set()
    ...
    visit(root,Affine())
    return dict(schema_version=1, scenes=scenes, raster_layers=rasters,
...
def rendering_capabilities():
    ...
    return dict(svg=dict(text='editable or outlined',gradients='vector',hatching='vector',
                         blending='vector',masks='explicit raster',scenes='embedded raster'),
