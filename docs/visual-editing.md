...
[Figure projects](project-workflows.md) provide verified asset bundles through the experimental API. Undo history is local to the open page and is not serialized.
