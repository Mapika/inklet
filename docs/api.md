...
* `bars(at: 'Sequence', heights, *, width: 'float' = 0.8, baseline: 'float' = 0.0, orient: 'str' = 'v', stacked: 'bool | None' = None, grouped: 'bool | None' = None, gap: 'float' = 0.12, colors=None, bar_colors=None, names: 'Sequence[str] | None' = None, labels=None, label_position: 'str' = 'auto', label_options: 'dict | None' = None, **style) -> "'Panel'"` -- A rectangle per value, standing on a baseline.
