...
**4.3.0 is the stable release** on GitHub and PyPI. It includes scientific
...
```sh
python -m pip install "inklet==4.3.0"
# Optional rendering and table integrations:
python -m pip install "inklet[render,pandas,polars]==4.3.0"
```
...
An ordinary upgrade selects stable 4.3.0. Exact pins preserve the package version
