...
**4.0.0.dev15** is the published preview on GitHub and PyPI. **3.1.0** remains
the stable release. Development on `master` targets **4.0.0.dev16**; new master
features are not included in the dev15 package.
...
To try unreleased master features from a checkout:
...
| Verified inputs and shared entity IDs (master/dev16) | [Figure projects](project-workflows.md) |
