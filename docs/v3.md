...
This is **3.0.0rc1**, the first release candidate. The feature set is frozen;
RC changes address compatibility, correctness and documentation. PyPI and the
stable documentation still provide 2.6. Install a checkout with
`python -m pip install -e '.[render]'` to try the candidate.
