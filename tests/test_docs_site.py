...
def test_strict_site_has_working_assets_search_and_rendered_examples(tmp_path, monkeypatch):
    ...
    guide_pages = ('plotting', 'plot-types', 'axes-and-scales', 'dense-data', 'data',
                   ...
                   'lines-and-points', 'bars-and-areas', 'distributions', 'relationships', 'uncertainty',
                   'matrices', 'polar-plots', 'interactive-documents', 'geographic-features', 'plot-recipes', 'composition-recipes', 'layout-overrides', 'layout-editor')
