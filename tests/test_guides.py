...
PAGES = ('README.md', 'docs/quickstart.md', 'docs/csv-figure.md', 'docs/concepts.md', 'docs/layout.md',
         ...
         'docs/distributions.md', 'docs/uncertainty.md', 'docs/matrices.md', 'docs/networks-and-hierarchies.md', 'docs/genomics-plots.md', 'docs/polar-plots.md', 'docs/geographic-features.md', 'docs/plot-recipes.md', 'docs/composition-recipes.md', 'docs/layout-overrides.md', 'docs/layout-editor.md', 'docs/project-workflows.md',
