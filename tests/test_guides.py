...
PAGES = ('README.md', 'docs/quickstart.md', 'docs/concepts.md', 'docs/layout.md',
         ...
         'docs/distributions.md', 'docs/uncertainty.md', 'docs/matrices.md', 'docs/polar-plots.md', 'docs/geographic-features.md', 'docs/plot-recipes.md', 'docs/composition-recipes.md')
