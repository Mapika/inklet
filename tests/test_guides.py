...
PAGES = ('README.md', 'docs/quickstart.md', 'docs/csv-figure.md', 'docs/concepts.md', 'docs/layout.md',
         ...
         'docs/distributions.md', 'docs/relationships.md', 'docs/uncertainty.md', 'docs/matrices.md', 'docs/networks-and-hierarchies.md', 'docs/genomics-plots.md', 'docs/polar-plots.md', 'docs/geographic-features.md', 'docs/plot-recipes.md', 'docs/composition-recipes.md', 'docs/layout-overrides.md', 'docs/layout-editor.md', 'docs/project-workflows.md',
...
def test_page_versions_preserve_filters_anchors_and_external_links():
    spec = importlib.util.spec_from_file_location('docs_site', ROOT/'tools/docs_site.py')
    module = importlib.util.module_from_spec(spec); spec.loader.exec_module(module)
    ...
    for unchanged in ('href="#local"', 'href="../asset.png"',
                      ...
                      'href="https://inklet.readthedocs.io/en/latest/"'):
        assert unchanged in result
    assert module.on_post_page(result, None, {'extra': {'page_version': 'revision'}}) == result
